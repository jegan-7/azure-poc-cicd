...
Azure state backend creation ############################ step :1
...
terraform { backend "azurerm" { resource_group_name = "rg-app-devops_Jegan" storage_account_name = "sttfstatejegandev01" container_name = "tfstate" key = "dev.tfstate" use_azuread_auth = true } }
